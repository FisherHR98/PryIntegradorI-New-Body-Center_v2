<%-- 
    ...
    Created on : 22/06/2022, 02:29:26 AM
    Author     : ASUS F15
--%>
...
<html>
    <head>
        ...
        <title>New Body Center | Contáctanos</title>
    ...
    <body>
        ...
        <div id="menu" class="container">
            ...
            <%--Login--%>
                <li class="login"><a href="#" onClick="window.location.href='login.jsp'">Login</a></li>
            </ul>
        </div>
        <h1>AQUI IRAN LOS NUMEROS, DIRECCION, CORREO, REDES SOCIALES, Y UN MAPA GPS</h1>
    </body>
</html>
